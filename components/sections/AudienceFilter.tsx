...
const COPY = {
  ...
  closing:
    "Se você se reconheceu em alguma dessas situações, a assessoria da Lema Digital foi feita pra destravar exatamente isso.",
};

export default function AudienceFilter() {
  const copyVariant = useCopyVariant();
  // Ângulo "diagnóstico" (raiz backup): heading e fechamento voltam ao gancho antigo
  const diag = copyVariant === "diagnostico";
  const headingMain = diag ? "Esse diagnóstico" : COPY.headingMain;
  const closing = diag
  ...
  return (
    <section
      id="para-quem-e"
      className="relative overflow-hidden scroll-mt-20 py-12 lg:py-16"
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Afirmações numeradas em 2 colunas (compacto) */}
